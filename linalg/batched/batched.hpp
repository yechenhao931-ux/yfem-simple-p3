...
/// @brief Class for performing serial batched linear algebra operations.
///
/// The static member functions delegate to the native backend.
class BatchedLinAlg
{
public:
   /// Available serial backend implementations.
   enum Backend
   {
      /// The standard MFEM backend, implemented using mfem::forall loops.
      NATIVE,
...
public:
   ...
   /// Return true if the requested backend is available.
