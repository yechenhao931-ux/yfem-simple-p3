...
{
   if (assembly_level != AssemblyLevel::LEGACY)
   {
      MFEM_ABORT("serial mini-MFEM keeps only AssemblyLevel::LEGACY");
   }
   assembly = AssemblyLevel::LEGACY;
}
                                              ...
                                              Vector &diag) const
{
   ...
   MFEM_ABORT("Not implemented. Assemble the mixed bilinear form into a "
